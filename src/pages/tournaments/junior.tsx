// src/pages/tournaments/junior.tsx
  ...
  return (
    <div className="min-h-screen">
      ...
      <div
        ...
        style={{ backgroundImage: `url(${fundraiserImage})` }}
      >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div className="max-w-3xl">
              <div className="flex items-center mb-6">
                <CircleDot className="h-8 w-8 md:h-12 md:w-12 text-[#C5A572]" />
              </div>
              ...
              <p className="text-base sm:text-lg md:text-xl text-white/90 mb-8 leading-relaxed">
                ...
                encouraging environment. Every tournament includes lunch for all players.
              </p>
              <Link
                to="/register/junior"
      ...
      <div className="bg-gray-50 py-12 lg:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <TournamentList leagueType="junior" />
        </div>
      </div>
    </div>
  );
